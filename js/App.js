...
tasks.addEventListener('click', function (event) {
  ...
  if (target.className === "showConfig") {
    tasks.querySelectorAll('.showPop').forEach(element=>{element.style.display="none"});//hide configModal if clicking on another edit button
  ...
  if (target.className === "edit") {
    ...
    item__title = target.closest('.tasks__item').querySelector('.item__title');
    item__description = target.closest('.tasks__item').querySelector('.item__description');
    item__prior=target.closest('.tasks__item').querySelector('.item__prior');
